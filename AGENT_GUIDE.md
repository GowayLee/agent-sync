...
- `repair`: Repair broken agent file links with content merging
...
- Implement Registry module for system-wide project indexing
- Add comprehensive tests for LinkManager functionality
- Add integration tests for full CLI workflow
- Implement `status --all` command functionality
